...
**LastUpdateTime** | [**time.Time**](time.Time.md) | The last time this condition was updated. | [optional] [default to null]
...
**Type_** | **string** | Type of deployment condition. | [default to null]
