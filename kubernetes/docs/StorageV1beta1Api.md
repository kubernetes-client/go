...
# **CreateStorageClass**
> V1beta1StorageClass CreateStorageClass(ctx, body, optional)
...
[**V1beta1StorageClass**](v1beta1.StorageClass.md)
...
> V1beta1VolumeAttachment CreateVolumeAttachment(ctx, body, optional)
...
[**V1beta1VolumeAttachment**](v1beta1.VolumeAttachment.md)
...
# **DeleteStorageClass**
> V1Status DeleteStorageClass(ctx, name, body, optional)
...
> V1Status DeleteVolumeAttachment(ctx, name, body, optional)
...
# **ListStorageClass**
> V1beta1StorageClassList ListStorageClass(ctx, optional)
...
[**V1beta1StorageClassList**](v1beta1.StorageClassList.md)
...
> V1beta1VolumeAttachmentList ListVolumeAttachment(ctx, optional)
...
[**V1beta1VolumeAttachmentList**](v1beta1.VolumeAttachmentList.md)
...
# **PatchStorageClass**
> V1beta1StorageClass PatchStorageClass(ctx, name, body, optional)
...
> V1beta1VolumeAttachment PatchVolumeAttachment(ctx, name, body, optional)
...
# **ReadStorageClass**
> V1beta1StorageClass ReadStorageClass(ctx, name, optional)
...
> V1beta1VolumeAttachment ReadVolumeAttachment(ctx, name, optional)
...
# **ReplaceStorageClass**
> V1beta1StorageClass ReplaceStorageClass(ctx, name, body, optional)
...
> V1beta1VolumeAttachment ReplaceVolumeAttachment(ctx, name, body, optional)
