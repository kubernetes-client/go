...
# **CreateAPIService**
> V1beta1ApiService CreateAPIService(ctx, body, optional)
...
# **ListAPIService**
> V1beta1ApiServiceList ListAPIService(ctx, optional)
...
# **PatchAPIService**
> V1beta1ApiService PatchAPIService(ctx, name, body, optional)
...
> V1beta1ApiService PatchAPIServiceStatus(ctx, name, body, optional)
...
# **ReadAPIService**
> V1beta1ApiService ReadAPIService(ctx, name, optional)
...
> V1beta1ApiService ReadAPIServiceStatus(ctx, name, optional)
...
# **ReplaceAPIService**
> V1beta1ApiService ReplaceAPIService(ctx, name, body, optional)
...
> V1beta1ApiService ReplaceAPIServiceStatus(ctx, name, body, optional)
