...
**UpdateStrategy** | [***V1beta2StatefulSetUpdateStrategy**](v1beta2.StatefulSetUpdateStrategy.md) | updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template. | [optional] [default to null]
